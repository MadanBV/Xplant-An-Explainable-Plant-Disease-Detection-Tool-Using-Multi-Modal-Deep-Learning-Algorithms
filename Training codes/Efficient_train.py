...
checkpoint = ModelCheckpoint('.\Trained models\efficientnet_25.keras', monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
...
model.save('.\Trained models\efficientnetv2_25.keras')
